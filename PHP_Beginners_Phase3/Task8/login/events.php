...
$sql4 = "SELECT EventName, EventDate, Venue, e.OrganizerID, o.OrganizerName FROM Events e JOIN Organizer o ON e.OrganizerID = o.OrganizerID;"; // Replace YourTableName with your actual table name
